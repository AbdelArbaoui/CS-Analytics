...
CS Analytics
Suite Reports — Boîte à outils desktop pour l'équipe Customer Success (Citadel & Cryptobox)

Platform Python GUI Tests Usage Status
...
🤝	Fiches Clients (Mini CRM)	Contacts, licences, cas d'usage — basepartagée entre tous les CSM, fusionnée automatiquement.
...
🖥️ Utilisation
Double-cliquez sur ​​Lancer_Suite_Reports.bat​ — une vérification de mise à jour réseau s'exécute automatiquement avant le démarrage.
Naviguez entre les pages depuis le menu de gauche.
Configurez vos chemins (dossiers, templates) — ils sont sauvegardés automatiquement.
Choisissez le client et les dates → Générer le rapport.
...
🛠️ Développement
Cliquer pour déplier — prérequis, tests, synchronisation, règles d'or
...
Règles d'or
🔴 ​​Citadel_Report_Tool/​ et ​Script Cryptobox/​ sont intouchables — boîtes noires exécutées en ​subprocess​.
✅ Toujours exécuter ​pytest​ (et ​sync_reports.py​ si propagation nécessaire) avant de livrer.
🔌 Toute nouvelle méthode ​Api​ doit utiliser ​@_api_endpoint(...)​ pour la validation et la gestion d'erreur.
📦 Les imports ​pptx​ restent dans ​ppt_helpers.py​, jamais dans ​main.py​.
🛡️ Utiliser systématiquement ​valider_nom_client()​, ​valider_date_iso()​, ​safe_subpath()​ (​config_helper.py​) sur toute entrée utilisateur ou chemin.
🔒 ​favoris.json​ ne doit jamais être écrit sur le réseau — toute nouvelle donnée locale-uniquement doit suivre ce même principe.
(retour en haut)
...
Outil interne Customer Success — Citadel & Cryptobox
